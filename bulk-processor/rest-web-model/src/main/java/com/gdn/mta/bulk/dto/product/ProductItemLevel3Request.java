...
public class ProductItemLevel3Request extends BaseRequest {
  ...
  public ProductItemLevel3Request(String itemSku, String skuCode, String merchantSku,
      ...
      String pickupPointCode, String pickupPointName, Integer deltaStock, Boolean synchronizeStock,
  ...
  public String toString() {
    return String
        .format(
            "ProductItemLevel3Request [itemSku=%s, skuCode=%s, merchantSku=%s, upcCode=%s, itemName=%s, length=%s, width=%s, height=%s, weight=%s, shippingWeight=%s, dangerousGoodsLevel=%s, lateFulfillment=%s, pickupPointCode=%s, pickupPointName=%s, deltaStock=%s, synchronizeStock=%s, prices=%s, viewConfigs=%s, images=%s, getItemSku()=%s, getSkuCode()=%s, getMerchantSku()=%s, getUpcCode()=%s, getItemName()=%s, getLength()=%s, getWidth()=%s, getHeight()=%s, getWeight()=%s, getShippingWeight()=%s, getDangerousGoodsLevel()=%s, getLateFulfillment()=%s, getPickupPointCode()=%s, getPickupPointName()=%s, getDeltaStock()=%s, getSynchronizeStock()=%s, getPrices()=%s, getViewConfigs()=%s, getImages()=%s]",
            ...
            deltaStock, synchronizeStock, prices, viewConfigs, images, getItemSku(), getSkuCode(),
            ...
            getPickupPointCode(), getPickupPointName(), getDeltaStock(), getSynchronizeStock(),
            getPrices(), getViewConfigs(), getImages());
  }
