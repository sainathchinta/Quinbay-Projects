...
@Slf4j
@Service
public class BulkGenericCreateExternalProductListener {
  ...
  @KafkaListener(topics = "#{kafkaTopicProperties.getBulkGenericCreateProductForExternalUpload()"
  ...
  public void onDomainEventConsumedForPriority1(String message) throws ApplicationException {
    String topic = kafkaTopicProperties.getBulkGenericCreateProductForExternalUpload();
