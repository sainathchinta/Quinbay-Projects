...
@Slf4j
@Service
public class BulkImagePriority2DownloadListener {
  ...
  @KafkaListener(topics = "#{kafkaTopicProperties.getBulkCreateDownloadImagePriority2()}", autoStartup = "#{kafkaTopicProperties.isAutoStartup()}")
  public void onDomainEventConsumed(String message) throws Exception {
    ...
    log.info("Download image {} with payload {} ", kafkaTopicProperties.getBulkCreateDownloadImagePriority2(), message);
    try {
      ...
      log.error("Error when listening to event {},  message : {} ",
          kafkaTopicProperties.getBulkCreateDownloadImagePriority2(), message, e);
    }
  }
}
