...
public class BulkAssigneeMasterSkuReviewListenerTest {
  ...
  @InjectMocks
  private BulkAssigneeMasterSkuReviewListener bulkAssigneeMasterSkuReviewListener;
  ...
  public void onDomainEventConsumedTest() throws Exception {
    ...
    Mockito.doNothing().when(internalProcessServiceWrapper)
      .processBulkMasterSkuAssigneeEvent(STORE_ID, INTERNAL_PROCESS_REQUEST_ID);
    bulkAssigneeMasterSkuReviewListener.onDomainEventConsumed(json);
    ...
    Mockito.verify(internalProcessServiceWrapper)
      .processBulkMasterSkuAssigneeEvent(STORE_ID, INTERNAL_PROCESS_REQUEST_ID);
    Mockito.verify(kafkaTopicProperties).getBulkAssigneeMasterSkuProcessEvent();
  }
  ...
  public void onDomainEventConsumedErrorTest() throws Exception {
    ...
    bulkAssigneeMasterSkuReviewListener.onDomainEventConsumed(json);
    Mockito.verify(objectMapper).readValue(json, InternalBulkUploadDataDomainEventModel.class);
    Mockito.verify(kafkaTopicProperties, Mockito.times(2)).getBulkAssigneeMasterSkuProcessEvent();
  }
}
