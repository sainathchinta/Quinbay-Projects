...
public class BulkGenericCreateExternalProductListenerTest {
  @Mock
  ...
  @InjectMocks
  private BulkGenericCreateExternalProductListener listener;

  private static final String STORE_ID = "store-123";
  private static final String BULK_PROCESS_CODE = "BPC-123";
  private static final String TOPIC = "bulk-generic-create-external-product-topic";
  ...
  public void testOnDomainEventConsumedForPriority1_Success() throws Exception {
    // Given
    when(kafkaTopicProperties.getBulkGenericCreateProductForExternalUpload()).thenReturn(TOPIC);
