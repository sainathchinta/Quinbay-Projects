...
public class BulkImagePriority1DownloadListenerTest {

  @InjectMocks
  private BulkImagePriority1DownloadListener bulkImageDownloadListener;
  ...
  public void onDomainEventConsumedTest() throws Exception {
    ...
    Mockito.verify(kafkaTopicProperties, Mockito.times(1)).getBulkCreateDownloadImagePriority1();
  }
  ...
  public void onDomainEventConsumedExceptionTest() throws Exception {
    ...
    Mockito.verify(bulkProcessService).downloadImages(null, null);
    Mockito.verify(objectMapper).readValue(Constant.CLIENT_ID, BulkImageDownloadEventModel.class);
    Mockito.verify(kafkaTopicProperties, Mockito.times(2)).getBulkCreateDownloadImagePriority1();
  }
}