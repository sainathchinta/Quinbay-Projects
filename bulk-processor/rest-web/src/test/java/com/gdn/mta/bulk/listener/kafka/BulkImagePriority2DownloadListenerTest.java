...
public class BulkImagePriority2DownloadListenerTest {

  @InjectMocks
  private BulkImagePriority2DownloadListener bulkImageDownloadListener;
  ...
  public void onDomainEventConsumedTest() throws Exception {
    ...
    Mockito.verify(kafkaTopicProperties).getBulkCreateDownloadImagePriority2();
  }
  ...
  public void onDomainEventConsumedExceptionTest() throws Exception {
    ...
    Mockito.verify(bulkProcessService).downloadImages(null, null);
    Mockito.verify(objectMapper).readValue(Constant.CLIENT_ID, BulkImageDownloadEventModel.class);
    Mockito.verify(kafkaTopicProperties, Mockito.times(2)).getBulkCreateDownloadImagePriority2();
  }
}