...
@Component(value = "bulkConfigurationCategorySummaryProcessHelper")
public class BulkConfigurationCategorySummaryProcessHelper extends BulkProcessHelper {

  private static final List<String> CATEGORY_HEADER_LIST =
      ImmutableList.<String>builder().add(BulkParameters.CONFIG_CATEGORY_CODE).add(BulkParameters.CONFIG_CATEGORY_NAME)
  ...
  public String getDirectory(BulkDownloadRequest request) {
    return ProcessorUtils.ENTITY_DIR_MAP.get(BulkProcessEntity.CONFIGURATION_CATEGORY_SUMMARY) + request.getRequestId();
  }
  ...
  public Map<String, Object> getEmailParams(BulkDownloadRequest request, String lang) {
    ...
    emailParameters.put(EmailConstants.TEMPLATE_ID_PARAM,
        MessageUtil.getMessage(EmailConstants.BULK_CATEGORY_CONFIGURATION_DOWNLOAD_TEMPLATE_ID, lang));
    emailParameters.put(EmailConstants.MAIL_SENDER_PARAM, EmailConstants.MAIL_SENDER);
    emailParameters.put(EmailConstants.MAIL_SUBJECT_PARAM, EmailConstants.CONFIGURATION_SUMMARY_CATEGORY_SUBJECT);
