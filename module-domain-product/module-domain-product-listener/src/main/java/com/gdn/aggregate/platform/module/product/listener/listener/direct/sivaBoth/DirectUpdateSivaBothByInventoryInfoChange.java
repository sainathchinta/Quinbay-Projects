...
@Component
@ConditionalOnProperty(name = Enabler.FLOW_DIRECT_UPDATE_SIVA_BOTH_BY_INVENTORY_INFO_CHANGE)
public class DirectUpdateSivaBothByInventoryInfoChange {
    ...
    public void onInventoryInfoChangeEventSivaBoth(ConsumerRecord<String, String> record) throws Exception {
        listenerService.onInventoryInfoChangeEvent(record,Topics.GROUP_ID_SIVA_BOTH_BY_INVENTORY_INFO_CHANGE,
