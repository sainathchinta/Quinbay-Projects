...
@Slf4j
@Component
@ConditionalOnProperty(name = Enabler.FLOW_RAW_PRODUCT_COMBINED_UPSERT_HIGH_VOLUME)
public class RawProductUpdateCombinedEventHighVolumeListener {
  ...
  @KafkaListener(topics = Topics.RAW_PRODUCT_COMBINED_UPSERT_HIGH_VOLUME, 
                 groupId = Topics.GROUP_ID_SIVA_PRODUCT_HIGH_VOLUME)
  public void onHighVolumeRawProductUpdateCombinedEvent(ConsumerRecord<String, String> record) throws Exception {
