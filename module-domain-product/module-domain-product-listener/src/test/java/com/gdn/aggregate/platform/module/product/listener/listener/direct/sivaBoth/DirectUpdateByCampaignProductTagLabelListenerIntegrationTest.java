...
public class DirectUpdateByCampaignProductTagLabelListenerIntegrationTest extends DummyHelper {
  ...
  @Test
  public void testOnCampaignProductTagLabelEvent_failed_processedDataNotExists() throws Exception {
    campaignProduct.setTimestamp(0L);
    campaignProduct.setTagLabel("new");
  ...
  @Test
  public void testOnCampaignProductTagLabelEvent_success() throws Exception {
    campaignProduct.setTimestamp(0L);
