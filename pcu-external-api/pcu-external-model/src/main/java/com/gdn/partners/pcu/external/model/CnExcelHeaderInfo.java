...
public interface CnExcelHeaderInfo {
  ...
  String STATUS_PENGIRIMAN_IN = "Online = 1, Offline = 0";
  String CNC_STATUS_IN = "On = 1, Off = 0";
  ...
  String BASE_PRICE_EN = "Enter the \n  base price. ";
  String BASE_PRICE_IN = "Tentukan  \n  Harga dasar. ";
  String MANAGED_STATUS = "Yes = 1, No = 0";
  String VARIANT_IMAGE_INFO_EN = "You can add photo \n for each variant.";
  String VARIANT_IMAGE_INFO_ID = "Anda bisa menambahkan \n foto untuk tiap varian.";
  String INSTORE_INFO_EN = "Please fill with number.\n" + "Online = 1, Offline = 0\n" + "\n"
      + "If one of the variant have\n instore status online, all\n variant in that product will\n be instore online as well";
  String INSTORE_INFO_ID = "Silakan isi dengan angka.\n" + "Online = 1, Offline = 0\n" + "\n"
      + "Jika salah satu variant\n memiliki status online\n, maka seluruh variant akan\n menjadi online untuk instore";
  String INSTORE_OPTIONAL_DESCRIPTION_EN = "(Optional for instore product only)";
  String INSTORE_OPTIONAL_DESCRIPTION_ID = "(Opsional untuk produk instore)";
  String MANDATORY_EN = "(Mandatory)";
  String MANDATORY_ID = "(Wajib diisi)";
}
