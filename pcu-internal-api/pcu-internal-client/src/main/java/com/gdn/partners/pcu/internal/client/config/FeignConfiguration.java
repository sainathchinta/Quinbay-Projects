package com.gdn.partners.pcu.internal.client.config;
...
public class FeignConfiguration {
  ...
  private static final String HALAL_URL = "/sertifikat";

  @Bean
  public SetterFactory setterFactory() {
    return (target, method) -> HystrixCommand.Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey(target.name()))
  ...
  public RequestInterceptor requestInterceptor() {
    return requestTemplate -> {
      ...
      if (requestTemplate.url().contains(HALAL_URL)) {
        return;
      }
