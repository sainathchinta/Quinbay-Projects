...
public class CategoryConfigurationDownloadRequest extends BulkDownloadRequest {
  ...
  @Builder(builderMethodName = "CategoryConfigurationDownloadRequestBuilder")
  public CategoryConfigurationDownloadRequest(String requestId, DownloadType downloadType, FileType fileType,
