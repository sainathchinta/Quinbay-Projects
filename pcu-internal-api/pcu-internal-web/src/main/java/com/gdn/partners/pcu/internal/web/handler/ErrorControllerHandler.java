package com.gdn.partners.pcu.internal.web.handler;
...
public interface ErrorControllerHandler {
  ...
  default BaseResponse constraintViolation(ConstraintViolationException e) {
    ...
    messages.addAll(
        constraintViolations.stream().map(constraintViolation -> String.format("%s", constraintViolation.getMessage()))
            .collect(Collectors.toList()));
    this.getLogger().warn(ConstraintViolationException.class.getName(), e);
    BaseResponse response = new BaseResponse();
