...
public class CreateBrandRequest implements Serializable {
  ...
  public CreateBrandRequest(String brandName, String brandDescription, String brandLogoPath) {
    super();
  ...
  public String toString() {
    return String.format("CreateBrandRequest [brandName=%s, brandDescription=%s, brandLogoPath=%s, profileBannerPath=%s]",
