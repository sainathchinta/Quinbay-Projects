...
public class UpdateProductLevel3ItemWip extends BaseResponse {

  private static final long serialVersionUID = 1666421204358767369L;
  ...
  public UpdateProductLevel3ItemWip() {

  }

  public UpdateProductLevel3ItemWip(String productLevel1ItemId, String gdnSku, String merchantSku,
  ...
  public String toString() {
    return "UpdateProductLevel3ItemWip{" + "productLevel1ItemId='" + productLevel1ItemId + '\'' + ", gdnSku='" + gdnSku
