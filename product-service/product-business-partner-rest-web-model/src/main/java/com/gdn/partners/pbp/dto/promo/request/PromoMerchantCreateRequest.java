...
public class PromoMerchantCreateRequest implements Serializable {
  private static final long serialVersionUID = -8033490564383620185L;
  ...
  public String toString() {
    return String.format(
        "PromoMerchantCreateRequest [itemSku=%s, promoType=%s, promoName=%s, promoStart=%s, promoEnd=%s, promoQuota=%s, promoRuleComboSet=%s, promoRuleWholesaleSet=%s, toString()=%s]",
        this.itemSku, this.promoType, this.promoName, this.promoStart, this.promoEnd,
