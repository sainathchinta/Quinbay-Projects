...
@Component("level2InventoryBelowMinimumStockEventStoreKafkaMessageProcessor")
public class Level2InventoryBelowMinimumStockEventStoreKafkaMessageProcessorBean extends
  ...
  protected EventStore saveToEventStore(Level2InventoryMinimumStockAlertEvent eventModel,
    ...
    Level2InventoryEventStore eventStore =
        modelConverter.convertToLevel2InventoryEventStore(eventModel, eventName, true);
