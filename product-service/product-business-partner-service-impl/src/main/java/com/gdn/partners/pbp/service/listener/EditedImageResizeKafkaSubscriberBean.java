...
@Service
@Slf4j
public class EditedImageResizeKafkaSubscriberBean {
  ...
  @KafkaListener(topics = DomainEventName.EDITED_IMAGE_RESIZE_EVENT, autoStartup = "#{kafkaTopicProperties.isAutoStartup()}")
  public void onDomainEventConsumed(String message) throws Exception {
    ...
    try {
      ...
      imageProcessorService.resizeEditedImage(bulkResizeImageRequest);
    } catch (Exception e) {
