...
@Component(value = ApproveImageWorkflowWorkerBean.BEAN_NAME + WorkflowWorker.SUFFIX_BEAN_NAME)
@Transactional(readOnly = true)
public class ApproveImageWorkflowWorkerBean implements WorkflowWorker {

  public static final String BEAN_NAME = "approveImage";
  ...
  public void process(Map<String, Object> datas) throws Exception {
    ...
    this.productLevel1WipService.approveImage(productCode);
