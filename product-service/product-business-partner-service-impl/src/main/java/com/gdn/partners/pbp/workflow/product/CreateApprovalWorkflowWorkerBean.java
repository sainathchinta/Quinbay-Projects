...
@Component(value = CreateApprovalWorkflowWorkerBean.BEAN_NAME + WorkflowWorker.SUFFIX_BEAN_NAME)
@Transactional(readOnly = true)
public class CreateApprovalWorkflowWorkerBean implements WorkflowWorker {

  public static final String BEAN_NAME = "createApproval";
