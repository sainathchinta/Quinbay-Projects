...
@Component(value = RejectImageWorkflowWorkerBean.BEAN_NAME + WorkflowWorker.SUFFIX_BEAN_NAME)
@Transactional(readOnly = true)
public class RejectImageWorkflowWorkerBean implements WorkflowWorker {

  public static final String BEAN_NAME = "rejectImage";
