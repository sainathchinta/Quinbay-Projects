 ...
 */
@Component(value = UpdateRejectedWorkflowWorkerBean.BEAN_NAME + WorkflowWorker.SUFFIX_BEAN_NAME)
@Transactional(readOnly = true)
public class UpdateRejectedWorkflowWorkerBean implements WorkflowWorker{

  public static final String BEAN_NAME = "updateRejected";
  ...
  public void process(Map<String, Object> datas) throws Exception {
    ...
    this.productLevel1WipService.updateRejectedProduct(productCode);
