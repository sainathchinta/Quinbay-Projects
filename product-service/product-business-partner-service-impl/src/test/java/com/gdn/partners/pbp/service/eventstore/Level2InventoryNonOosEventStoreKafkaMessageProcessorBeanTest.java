...
public class Level2InventoryNonOosEventStoreKafkaMessageProcessorBeanTest {
  @Mock
  ...
  @InjectMocks
  private Level2InventoryNonOosEventStoreKafkaMessageProcessorBean kafkaMessageProcessor;

  private Level2InventoryNonOosEvent eventModel;

  private static final String eventName = "Test Level2InventoryNonOos";
  ...
  public void initializeTest() {
    ...
    Mockito.when(
        modelConverter.convertToLevel2InventoryEventStore(
            Mockito.any(Level2InventoryNonOosEvent.class), Mockito.anyString())).thenReturn(
    ...
    Mockito
        .when(
            systemParameterService
                .getParameter("sysparam.consumer.kafka.inventory-non-oos-event-store-processor-running"))
  ...
  public void process_IndexingRunning_Test() {
    ...
    Mockito.verify(modelConverter).convertToLevel2InventoryEventStore(
        (Level2InventoryNonOosEvent) Mockito.any(), Mockito.anyString());
