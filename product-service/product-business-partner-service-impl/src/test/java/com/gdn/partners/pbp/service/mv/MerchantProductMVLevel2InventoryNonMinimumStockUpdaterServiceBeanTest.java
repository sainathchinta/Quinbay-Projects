...
import com.gdn.partners.pbp.service.mv.updater.MerchantProductMVLevel2InventoryNonMinimumStockUpdaterServiceBean;
import com.gdn.mta.domain.event.modal.Level2InventoryMinimumStockAlertEvent;

public class MerchantProductMVLevel2InventoryNonMinimumStockUpdaterServiceBeanTest {
  @Mock
  MerchantProductMVRepository merchantProductMVRepository;

  @InjectMocks
  MerchantProductMVLevel2InventoryNonMinimumStockUpdaterServiceBean service;
