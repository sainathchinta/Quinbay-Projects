...
import com.gdn.partners.pbp.service.mv.updater.MerchantProductMVLevel2InventoryNonOosEventUpdaterServiceBean;
import com.gdn.mta.domain.event.modal.Level2InventoryNonOosEvent;

public class MerchantProductMVLevel2InventoryNonOosUpdaterServiceBeanTest {
  @Mock
  MerchantProductMVRepository merchantProductMVRepository;

  @InjectMocks
  MerchantProductMVLevel2InventoryNonOosEventUpdaterServiceBean service;
  MerchantProductMV savedMv;
  Level2InventoryNonOosEvent eventModel;
  ...
  public void initializeTest() {
    ...
    eventModel = new Level2InventoryNonOosEvent();
