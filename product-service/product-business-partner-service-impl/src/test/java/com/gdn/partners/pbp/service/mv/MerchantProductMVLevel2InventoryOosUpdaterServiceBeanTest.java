...
import com.gdn.partners.pbp.service.mv.updater.MerchantProductMVLevel2InventoryOosEventUpdaterServiceBean;
import com.gdn.mta.domain.event.modal.Level2InventoryOosEvent;

public class MerchantProductMVLevel2InventoryOosUpdaterServiceBeanTest {
  ...
  @InjectMocks
  MerchantProductMVLevel2InventoryOosEventUpdaterServiceBean service;
  MerchantProductMV savedMv;
  Level2InventoryOosEvent eventModel;
  ...
  public void initializeTest() {
    ...
    eventModel = new Level2InventoryOosEvent();
