...
import com.gdn.partners.pbp.workflow.product.ApproveImageWorkflowWorkerBean;

public class ApproveImageWorkflowWorkerTest {
  ...
  @InjectMocks
  private ApproveImageWorkflowWorkerBean approveImageWorkflowWorkerBean;

  @BeforeEach
  public void initializeTest() throws Exception {
    MockitoAnnotations.initMocks(this);
    Mockito.doNothing().when(this.productLevel1WipService).approveImage(Mockito.anyString());
  ...
  public void processTest() throws Exception {
    this.approveImageWorkflowWorkerBean.process(new HashMap<String, Object>());
    Mockito.verify(this.productLevel1WipService).approveImage(Mockito.anyString());
