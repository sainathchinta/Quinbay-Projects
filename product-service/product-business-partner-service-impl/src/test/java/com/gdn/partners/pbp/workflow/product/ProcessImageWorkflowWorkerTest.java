...
import com.gdn.partners.pbp.workflow.product.ProcessImageWorkflowWorkerBean;

public class ProcessImageWorkflowWorkerTest {

  @Mock
  private ProductLevel1HistoryService productLevel1HistoryService;

  @InjectMocks
  private ProcessImageWorkflowWorkerBean processImageWorkflowWorkerBean;
  ...
  public void processTest() throws Exception {
    this.processImageWorkflowWorkerBean.process(new HashMap<String, Object>());
