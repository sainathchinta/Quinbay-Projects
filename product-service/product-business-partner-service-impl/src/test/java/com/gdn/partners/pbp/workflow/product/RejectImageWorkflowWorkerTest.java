...
import com.gdn.partners.pbp.workflow.product.RejectImageWorkflowWorkerBean;

public class RejectImageWorkflowWorkerTest {

  @Mock
  private ProductLevel1HistoryService productLevel1HistoryService;

  @InjectMocks
  private RejectImageWorkflowWorkerBean rejectImageWorkflowWorkerBean;
  ...
  public void processTest() throws Exception {
    this.rejectImageWorkflowWorkerBean.process(new HashMap<String, Object>());
