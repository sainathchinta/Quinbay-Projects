...
import com.gdn.x.product.dao.api.ItemArchiveCustomRepository;
...
@Repository
public class ItemArchiveRepositoryCustomImpl implements ItemArchiveCustomRepository {
  ...
  public void deleteByProductSku(List<String> productSkus) {
    ...
    mongoTemplateFactory.get(mandatoryParameterHelper.getReadPreference())
        .remove(new Query(criteria), ItemArchive.class);
  }
}
