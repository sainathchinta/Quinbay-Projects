...
public class OfflineItemChange extends ProductBaseDomainEventModel implements Serializable {
  ...
  public OfflineItemChange() {
  }

  public OfflineItemChange(String uniqueId, String merchantCode, String itemSku, String merchantSku,
      String pickupPointCode, String externalPickupPointCode, String productSku,
      Double listPrice, Double offerPrice, Boolean newData) {
  ...
  public String toString() {
    return "OfflineItemChange{" + "uniqueId='" + uniqueId + '\'' + ", merchantCode='" + merchantCode
