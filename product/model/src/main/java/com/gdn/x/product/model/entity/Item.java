...
@NoArgsConstructor
@AllArgsConstructor
@Document(collection = Item.DOCUMENT_NAME)
public class Item extends GdnBaseMongoEntity {

  private static final long serialVersionUID = 1L;

  public static final String DOCUMENT_NAME = "prd_item";
  ...
  @Field(value = ProductFieldNames.OMNI_CHANNEL_SKU)
  ...
  @Field(value = ProductFieldNames.PERMANENT_DELETE)
  ...
  @Field(value = ProductFieldNames.PREFERRED_SUBSCRIPTION_TYPE)
  private Set<String> preferredSubscriptionType;

  @Transient
  private Set<String> oldPreferredSubscriptionType;
  ...
  @Field(value = ProductFieldNames.BUNDLE_RECIPE)
  private Set<BundleRecipe> bundleRecipe;

  @Field(value = ProductFieldNames.MASTER_SKU)
  private String masterSku;

  @Transient
  private Set<String> updatedFields = new HashSet<>();

  public Item(String itemSku, String productSku) {
  ...
  public void setItemViewConfigsIfNotNullOrEmpty(Set<ItemViewConfig> itemViewConfig) {
    if (itemViewConfig != null && !itemViewConfig.isEmpty())
      this.itemViewConfigs = itemViewConfig;
  }
  ...
  public void setArchivedBeforeSuspension(Boolean isArchivedBeforeSuspension) {
    this.isArchivedBeforeSuspension = isArchivedBeforeSuspension;
  }

  public Boolean getArchivedBeforeSuspension() {
    return this.isArchivedBeforeSuspension;
  }
