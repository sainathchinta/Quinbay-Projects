...
@Builder
public class ItemViewConfig implements GdnBaseEmbedded {
  ...
  @Field(value = ProductFieldNames.ITEM_DISCOVERABLE_SCHEDULES)
  private ItemDiscoverableSchedule itemDiscoverableSchedules;

  @Field(value = ProductFieldNames.ITEM_DISPLAYABLE_SCHEDULES)
  ...
  public void setItemBuyableScheduleIfNotNull(ItemBuyableSchedule itemBuyableSchedule) {
    if (itemBuyableSchedule != null) {
      this.itemBuyableSchedules = itemBuyableSchedule;
    }
  }
  ...
  public void setItemDiscoverableScheduleIfNotNull(
      ItemDiscoverableSchedule itemDiscoverableSchedule) {
    if (itemDiscoverableSchedule != null) {
      this.itemDiscoverableSchedules = itemDiscoverableSchedule;
    }
  }
