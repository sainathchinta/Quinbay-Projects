...
public class ComboItem implements Serializable {
  ...
  private List<ProductAttributeDetailDTO> masterDataItemAttributeValues =
  ...
  private List<ItemCatalogDTO> salesCatalogs = new ArrayList<ItemCatalogDTO>();
  private String pristineId;

  public ComboItem() {
  }

  public ComboItem(int quantity, double discountPercentage, boolean mainSku, String productName,
      List<ProductAttributeDetailDTO> masterDataItemAttributeValues, String imageUrl,
      ...
      boolean buyable, String brand, String merchantCode, ItemCatalogDTO masterCatalog,
      List<ItemCatalogDTO> salesCatalogs, String pristineId) {
  ...
  public List<ProductAttributeDetailDTO> getMasterDataItemAttributeValues() {
  ...
  public void setMasterDataItemAttributeValues(
      List<ProductAttributeDetailDTO> masterDataItemAttributeValues) {
    this.masterDataItemAttributeValues = masterDataItemAttributeValues;
  }
  ...
  public String toString() {
    final StringBuilder sb = new StringBuilder("ComboItem{");
