package com.gdn.x.product.rest.web.helper.impl;
    ...
    private void updateParameter(Parameter parameter) {
        ...
        switch(name) {
            ...
            case CHANNEL_ID_PARAM_NAME:
                updateStringSchema(parameter, "Channel Id", "ProductChannel");
                break;
            case CLIENT_ID_PARAM_NAME:
                updateStringSchema(parameter, "Client Id", "ProductClient");
                break;
